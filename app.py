...
st.set_page_config(page_title="Neeraj's ML Projects", layout="wide", page_icon="🧑‍⚕️")

# Sidebar for ML project selection
with st.sidebar:
    selected_project = option_menu("Neeraj's ML Projects",
                                   ["Multiple Disease Prediction"],
                                   icons=["layers"],
                                   menu_icon="cast", default_index=0)

# If "Project 1" is selected, show a second dropdown for specific models
if selected_project == "Multiple Disease Prediction":
    with st.sidebar:
        selected_model = option_menu("Choose Model",
                                     ["Diabetes Prediction", "Heart Disease Prediction", "Parkinson's Prediction"],
                                     icons=['activity', 'heart', 'person'], menu_icon="stethoscope", default_index=0)
